...
class PublicUserAPITests(TestCase):
    ...
    def test_create_valid_user_is_successful(self):
        payload = {"email": "nilo@test.com", "password": "1234567", "name": "Test Name"}
    ...
    def test_password_too_short(self):
        ...
        payload = {"email": "nilo@test.com", "password": "123", "name": "Test Name"}
    ...
    def test_invalid_email(self):
        ...
        payload = {"email": "nilo.com", "password": "1234567", "name": "Test Name"}
...
class PrivateUserAPITests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(
            email="test_user@gmail.com", password="12345678", name="Some User"
        )
        self.client = APIClient()
